<?php
/**
 * The template for displaying the Tags template in the BallBuster Music theme.
 *
...
<div class="searchProfile">
  <h1 class="search-title">
    <?php echo $wp_query->found_posts; ?> <?php _e( 'Post(s) Found For', 'locale' ); ?>: <span><?php echo single_tag_title(); ?></span>
  </h1>
</div>
