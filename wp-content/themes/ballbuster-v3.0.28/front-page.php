...
if ( $query->have_posts() ) {
 while ( $query->have_posts() ) {
   $query->the_post(); ?>
         <input class="carousel-open" type="radio" id="<?php echo "carousel-" . $carousel_number; ?>" name="carousel" aria-hidden="true" hidden="" checked="">
         <div class="carousel-item" style="background-image:url(<?php the_post_thumbnail_url(); ?>)">
          ...
          echo $category[0]->cat_name; ?></span>
             ...
             <p class="title author-title">By <?php the_author(); ?> | <?php the_date() ?></p>
           </a>
         </div>
...
<section id="categoryLists">
  <div class="list-1">
    ...
    <a href="https://louderthanlife.frontgatetickets.com/?utm_source=BallBusterMusic"><img width="100%" src="https://www.ballbustermusic.com/wp-content/uploads/2019/05/3lHc4EKA.jpeg" alt="Tickets on sale now"></a>
    <!-- End Temporaly ad placement -->



    <!-- <h2><a href="<?php echo esc_url( home_url( '/' ) ); ?>category/quickchat/">Quick Chat!</a></h2>

    <?php
    $query = new WP_Query( 'posts_per_page=4' . '&category_name=quickchat' ); ?>
...
<?php } ?> -->
  ...
  <div class="list-3">
    ...
    <!-- Temporaly ad placement -->
    <a href="https://bourbon.frontgatetickets.com/?utm_source=BallBusterMusic"><img width="100%" src="https://www.ballbustermusic.com/wp-content/uploads/2019/05/8qQnj0zw.jpeg" alt="Tickets on sale now"></a>
    <!-- End Temporaly ad placement -->
